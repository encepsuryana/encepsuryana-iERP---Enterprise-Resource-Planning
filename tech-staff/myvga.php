...
<tr>
		<td><?php
			...
			<td width="80" class="empty"><a rel="tooltip"  title="Update Status" id="e<?php echo $id; ?>" href="devlvga_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'id_location='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Status</a></td>
		</tr>
