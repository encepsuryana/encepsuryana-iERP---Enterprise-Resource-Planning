					...
					<div class="offset2">
						<div id="block_bg" class="block">
							<div class="navbar navbar-inner block-header">
								<div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Staff Teknis change Password</div>
								<div class="muted pull-right"><a id="return" data-placement="left" title="Klik untuk kembali" href="dashboard_client.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
							...
							<div class="block-content collapse in">
								<div class="span12">
									...
									<form  method="post" id="change_password" class="form-horizontal">
										...
										<div class="control-group">
											<div class="controls">
												<button id="update" data-placement="right" title="Klik untuk simpan" type="submit" class="btn btn-info"><i class="icon-save"></i> Save</button>
											</div>
										</div>
										<script type="text/javascript">
											$(document).ready(function(){
