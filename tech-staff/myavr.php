        ...
        <div class="container-fluid">
            ...
            <div id="block_bg" class="block">
               ...
               <div id="" class="muted pull-right">
				...
				OR NOT EXISTS 
                (select * from tbl_location_details where status_asset='Dump')
				and type_asset = 'automtic Voltge Regulator'      and id_location = '$get_id'")or die(mysql_error());
...
<tr>
		<td><?php
			...
			<td width="80" class="empty"><a rel="tooltip"  title="Update Status" id="e<?php echo $id; ?>" href="devlavr_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'id_location='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Status</a></td>			
		</tr>
