		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<a id="return" data-placement="left" title="Klik untuk kembali" href="mymonitor.php<?php echo '?id_location='.$id_location; ?>"><i class="icon-arrow-left"></i> Back</a>
										</div>
									...
									<div id="hide">
										...
										?>
										<script>
										window.location = "mymonitor.php<?php echo '?id_location='.$id_location; ?>"; 
