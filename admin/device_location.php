...
<body id="class_div">
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							...
							<div id="" class="muted pull-right">
								<?php 
								$my_location = mysql_query("select * from tbl_location ")or die(mysql_error());
						...
						<div class="block-content collapse in">
							<div class="span12">
								<ul	 id="da-thumbs" class="da-thumbs">
									<?php 
									$query = mysql_query("select * from tbl_location")or die(mysql_error());									
									...
									if ($count > 0){
										while($row = mysql_fetch_array($query)){
											...
											<li id="del<?php echo $id; ?>">
												<a href="mydevice.php<?php echo '?id_location='.$id_location; ?>">
	...
	<?php include('../tech-staff/script.php'); ?>
</body>
