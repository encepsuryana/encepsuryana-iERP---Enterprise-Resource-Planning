	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<a id="return" data-placement="left" title="Klik untuk kembali" href="mypower_supply.php<?php echo '?id_location='.$id_location; ?>"><i class="icon-arrow-left"></i> Back</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										?>
										<script>
										window.location = "mypower_supply.php<?php echo '?id_location='.$id_location; ?>"; 
