	               ...
	               <script type="text/javascript">
		              ...
		              $('#add').tooltip('hide');
                        ...
                        <div class="block">
							...
							<?php
							$query = mysql_query("select * from tbl_location where id_location = '$get_id'")or die(mysql_error());
                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
									...
									<div class="control-group">
                                          <div class="controls">
												<button name="update" class="btn btn-success" id="update" data-placement="right" title="Klik untuk simpan"><i class="icon-save icon-large"> Save</i></button>
                                                <script type="text/javascript">
	                                            $(document).ready(function(){
	                                            $('#update').tooltip('show');
	                                            $('#update').tooltip('hide');
