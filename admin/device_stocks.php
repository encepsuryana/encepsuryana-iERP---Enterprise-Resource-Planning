				...
				<div class="row-fluid">
					...
					<div id="block_bg" class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left"><i class="icon-reorder icon-large"></i> Data Aset</div>
							<div class="muted pull-right">
								Jumlah seluruh aset: <span class="badge badge-info"><?php  echo $count; ?></span>
							</div>
						</div>
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
											...
											<tbody>
												...
												while($row = mysql_fetch_array($device_query)){
													...
													if($row['status_asset']=='New')
													{
														echo '<div class="alert alert-success"><i class="icon-check"></i><strong> Baru </strong></div>';
													}
													else if($row['status_asset']=='Used')
													{
														echo '<div class="alert alert-warning"><i class="icon-ok"></i><strong> Digunakan </strong></div>';
													}
													else if($row['status_asset']=='Repaired')
													{
														echo '<div class="alert alert-warning"><i class="icon-wrench"></i><strong>Perbaikan</strong></div>';
													}
													else
													{
														echo '<div class="alert alert-danger"><i class="icon-remove-sign"></i><strong> Rusak</strong></div>';
													};
													?></td>

													<?php include('toolttip_edit_delete.php'); ?>												
													<td class="empty" width="80"><a rel="tooltip"  title="Edit Aset" id="e<?php echo $id; ?>" href="device_edit.php<?php echo '?id='.$id; ?>" class="btn btn-light"><i class="icon-pencil"></i></a></td>
												</tr>
