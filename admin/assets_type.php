	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span3" id="adduser">
				<?php include('add_assets_type.php'); ?>		   			
			</div>
			<div class="span6" id="">
				<div class="row-fluid">
					<!-- block -->
					...
					<div id="block_bg" class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								<form action="delete_assets_type.php" method="post">
										...
										<tbody>
											...
											while($row = mysql_fetch_array($tbl_asset_type_query)){
												...
												<tr>
													...
													<td width="75">
														<a rel="tooltip"  title="Edit Tipe Aset" id="e<?php echo $id; ?>" href="edit_assets_type.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
													</td>
