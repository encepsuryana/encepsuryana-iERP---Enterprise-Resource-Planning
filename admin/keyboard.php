...
<!-----------------------------------Content------------------------------------>
		...
		LEFT JOIN tbl_asset_type ON tbl_assets.id_asset=tbl_asset_type.id_asset
		where type_asset = 'Keyboard' OR type_asset = 'keyboard'
		OR type_asset = 'kyboard' OR type_asset = 'kboard' OR type_asset = 'kbard' OR type_asset = 'kbord'OR type_asset = 'kbrd'
		OR type_asset = '(keyboard)' OR type_asset = '(kbrd)'
