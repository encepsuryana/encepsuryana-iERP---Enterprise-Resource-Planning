...
mysql_query("insert into activity_log (date,user_admin,action) values(NOW(),'$admin_username','Dump Device $type_asset Inventory Code:$dev_serial')")or die(mysql_error());						
