...
<tr>
		<td><?php
			...
			<a rel="tooltip"  title="Update Status" id="t<?php echo $id; ?>" href="devlcpu_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'id_location='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Status</a></td>
		</tr>
