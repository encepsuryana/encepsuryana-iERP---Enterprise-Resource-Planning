					...
					<div id="block_bg" class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								<?php
								$query = mysql_query("select * from tbl_admin where id_admin = '$session_id'")or die(mysql_error());
									...
									<div class="row-fluid">
										...
										<form  method="post" id="change_password" class="form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="hidden" id="password" name="password" value="<?php echo $row['pass_admin']; ?>"  placeholder="Current Password">
