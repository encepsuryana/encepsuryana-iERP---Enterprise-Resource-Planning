		...
		<div class="row-fluid">
			...
			<div class="span6" id="">
				<div class="row-fluid">
					...
					<?php	
					$count_user=mysql_query("select * from tbl_admin");
					$count = mysql_num_rows($count_user);
					?>	 
					<div id="block_bg" class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left"></i><i class="icon-user"></i> Daftar Pengguna Admin</div>
							<div class="muted pull-right">
								Jumlah pengguna Admin <span class="badge badge-info"><?php  echo $count; ?></span>
							</div>
						</div>
							...
							<div class="span12">
								<form action="delete_users.php" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
											<?php
											$user_query = mysql_query("select * from tbl_admin")or die(mysql_error());
											while($row = mysql_fetch_array($user_query)){
												...
												<tr>
													...
													<td><?php echo $row['firstnm_admin']; ?> <?php echo $row['lastnm_admin']; ?></td>
